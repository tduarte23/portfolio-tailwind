...
import heroImg from "../public/main2.png"
        ...
        <section className="min-h-screen pt-5 pb-7">
            <div className='py-10 mb-12 flex justify-between '>
              ...
              <ul className={navMenu ? 'lg:visible lg:flex lg:items-center lg:gap-4 invisible' : 'visible flex flex-col gap-3 z-10 lg:invisible'}>
                ...
                <li>
                  <a href="#" className='bg-gradient-to-r from-cyan-500 to-teal-500 text-white px-4 py-2 border-none rounded-md '>Contato</a>
                </li>
              </ul>
            </div>
              ...
              <div className='p-10 '>
                ...
                <div className='text-5xl flex gap-16 py-3 text-gray-600'>       
                  <IconContext.Provider value={{ color: darkMode ? "white":"" }}>
                        <a href="https://www.linkedin.com/in/thomas-duarte-lopes-b32702220/" target="_blank" rel="noopener noreferrer">
                          <AiFillTwitterCircle className='hover:fill-cyan-500 cursor-pointer' />
                          </a>
                        <AiFillLinkedin className='hover:fill-cyan-500 cursor-pointer'/>
                        <AiFillGithub className='hover:fill-cyan-500 cursor-pointer'/>
                ...
                <div className='relative mx-auto mt-10 w-80 h-80  lg:w-98 lg:h-98'>
                  <Image src={heroImg} className=' hover:animate-waving-hand'  fill={false} alt="Hero Image"/>
                </div>
              </div>
        </section>
